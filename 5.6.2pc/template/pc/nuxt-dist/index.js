...
import nuxt_plugin_cookieuniversalnuxt_298c4cb8 from 'nuxt_plugin_cookieuniversalnuxt_298c4cb8' // Source: .\\cookie-universal-nuxt.js (mode: 'all')
import nuxt_plugin_axios_128bb1fc from 'nuxt_plugin_axios_128bb1fc' // Source: .\\axios.js (mode: 'all')
...
import nuxt_plugin_dynamicscriptsclient_053fe422 from 'nuxt_plugin_dynamicscriptsclient_053fe422' // Source: ..\\plugins\\dynamic-scripts.client.js (mode: 'client')
import nuxt_plugin_plugin_a5d596aa from 'nuxt_plugin_plugin_a5d596aa' // Source: .\\auth\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"","meta":[{"charset":"utf-8"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"http-equiv","http-equiv":"X-UA-Compatible","content":"IE=edge"},{"hid":"keywords","name":"keywords","content":"昆明阔翔科技有限公司，办公用品，办公耗材，得力，晨光"},{"hid":"description","name":"description","content":"昆明阔翔科技有限公司，办公用品，办公耗材，得力文具，晨光文具"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_cookieuniversalnuxt_298c4cb8 === 'function') {
    await nuxt_plugin_cookieuniversalnuxt_298c4cb8(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_128bb1fc === 'function') {
    await nuxt_plugin_axios_128bb1fc(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_dynamicscriptsclient_053fe422 === 'function') {
    await nuxt_plugin_dynamicscriptsclient_053fe422(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_a5d596aa === 'function') {
    await nuxt_plugin_plugin_a5d596aa(app.context, inject)
  }
