...
var _default2 = exports.default = /* define-vxe-component start */(0, _comp.defineVxeComponent)({
  ...
  props: {
    ...
    strict: {
      ...
      default: function _default() {
        return (0, _ui.getConfig)().radioGroup.strict;
      }
    },
    size: {
      type: String,
      default: function _default() {
        return (0, _ui.getConfig)().radioGroup.size || (0, _ui.getConfig)().size;
      }
    }
  },
  inject: {
  ...
  methods: {
    ...
    dispatchEvent: function dispatchEvent(type, params, evnt) {
      var $xeRadioGroup = this;
      $xeRadioGroup.$emit(type, (0, _ui.createEvent)(evnt, {
    ...
    renderVN: function renderVN(h) {
      ...
      var btnComp = type === 'button' ? _button.default : _radio.default;
      return h('div', {
