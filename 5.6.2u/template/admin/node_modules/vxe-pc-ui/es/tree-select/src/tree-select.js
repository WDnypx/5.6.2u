...
export default {
    ...
    methods: {
        ...
        updatePlacement() {
            ...
            const targetElem = $xeTreeSelect.$refs.refElem;
            const panelElem = $xeTreeSelect.$refs.refOptionPanel;
        ...
        handleGlobalMousedownEvent(evnt) {
            ...
            const isDisabled = $xeTreeSelect.computeIsDisabled;
            if (!isDisabled) {
                const el = $xeTreeSelect.$refs.refElem;
                const panelElem = $xeTreeSelect.$refs.refOptionPanel;
