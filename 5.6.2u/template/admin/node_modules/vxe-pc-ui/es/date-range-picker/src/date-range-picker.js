...
export default {
    ...
    methods: {
        ...
        emitModel(value) {
            const $xeDateRangePicker = this;
            const { _events } = $xeDateRangePicker;
        ...
        handleChange(sValue, eValue, evnt) {
            ...
            if (XEUtils.toValueString(modelValue) !== value) {
                $xeDateRangePicker.dispatchEvent('change', { value }, evnt);
                // 自动更新校验状态
        ...
        handleGlobalMousedownEvent(evnt) {
            ...
            const el = $xeDateRangePicker.$refs.refElem;
            const panelWrapperElem = $xeDateRangePicker.$refs.refPanelWrapper;
            const isDisabled = $xeDateRangePicker.computeIsDisabled;
        ...
        focus() {
            const $xeDateRangePicker = this;
            const reactData = $xeDateRangePicker.reactData;
            const inputElem = $xeDateRangePicker.$refs.refInputTarget;
            reactData.isActivated = true;
            inputElem.focus();
            return $xeDateRangePicker.$nextTick();
        },
