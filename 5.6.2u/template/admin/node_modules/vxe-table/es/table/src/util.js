...
// 组装列配置
export function assembleColumn(_vm) {
    ...
    if (groupConfig) {
        ...
        staticColumns.splice(XEUtils.arrayIndexOf($xeTable.$refs.hideColumn.children, $el), 0, columnConfig);
    }
}
// 销毁列
export function destroyColumn(_vm) {
    const $xeTable = _vm.$xeTable;
    const reactData = $xeTable;
    const { staticColumns } = reactData;
