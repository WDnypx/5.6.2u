...
function renderCellDragIcon(h, params) {
    ...
    return h('span', {
        ...
        ? $table.callSlot(rowDragIconSlot, params, h)
        : [
            h('i', {
    ...
    if (columnOpts.drag && showIcon && (!visibleMethod || visibleMethod(params))) {
        if (!column.fixed && (isPeerDrag || isCrossDrag || !column.parentId)) {
            ...
            return h('span', {
                ...
                ? $table.callSlot(columnDragIconSlot, params, h)
                : [
                    h('i', {
...
export const Cell = {
    ...
    renderRadioHeader(h, params) {
        ...
        return renderHeaderCellBaseVNs(h, params, renderTitleContent(h, params, headerSlot
    ...
    renderEditHeader(h, params) {
        ...
        return renderHeaderCellBaseVNs(h, params, editIconVNs.concat(Cell.renderHeaderTitle(h, params))
