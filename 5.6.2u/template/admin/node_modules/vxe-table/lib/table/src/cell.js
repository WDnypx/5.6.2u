...
function renderHeaderCellBaseVNs(h, params, content) {
  const vns = [renderTitlePrefixIcon(h, params), renderHeaderCellDragIcon(h, params), ...(_xeUtils.default.isArray(content) ? content : [content]), renderTitleSuffixIcon(h, params)];
  return vns;
}
...
function getFooterContent(h, params) {
  ...
  if (renderOpts) {
    ...
    if (rtFooter) {
      return (0, _vn.getSlotVNs)(rtFooter.call($table, h, renderOpts, footParams));
    }
  }
...
const Cell = exports.Cell = {
  createColumn($xeTable, _vm) {
    ...
    return (0, _util.createColumn)($xeTable, _vm, renConfs);
  },
  /**
   * 列头标题
   */
  renderHeaderTitle(h, params) {
    ...
    return renderTitleContent(h, params, (0, _utils.formatText)(column.getTitle(), 1));
  },
  ...
  renderDefaultCell(h, params) {
    ...
    if (renderOpts) {
      ...
      if (renderFn) {
        return renderCellBaseVNs(h, params, (0, _vn.getSlotVNs)(renderFn.call($table, h, renderOpts, Object.assign({
    ...
    // 如果设置占位符
    editRender && (0, _utils.eqEmptyValue)(cellValue) ? h('span', {
      class: 'vxe-cell--placeholder'
    }, (0, _utils.formatText)((0, _utils.getFuncText)(cellPlaceholder), 1)) : h('span', (0, _utils.formatText)(cellValue, 1))])]);
  },
  ...
  renderSeqHeader(h, params) {
    ...
    return renderHeaderCellBaseVNs(h, params, renderTitleContent(h, params, slots && slots.header ? $table.callSlot(slots.header, params, h) : (0, _utils.formatText)(column.getTitle(), 1)));
  },
  renderSeqCell(h, params) {
    ...
    return renderCellBaseVNs(h, params, [h('span', `${(0, _utils.formatText)(seqMethod ? seqMethod(params) : treeConfig ? seq : (seqOpts.startIndex || 0) + seq, 1)}`)]);
  },
  ...
  renderRadioHeader(h, params) {
    ...
    }, titleSlot ? $table.callSlot(titleSlot, params, h) : (0, _utils.formatText)(column.getTitle(), 1))]));
  },
  ...
  renderExpandCell(h, params) {
    ...
    }, defaultSlot ? $table.callSlot(defaultSlot, params, h) : _xeUtils.default.get(row, labelField)) : renderEmptyElement($table)]);
  },
  ...
  renderEditHeader(h, params) {
    ...
    if ((0, _utils.isEnableConf)(editConfig)) {
      editIconVNs = [isRequired && editOpts.showAsterisk ? h('i', {
        ...
        class: 'vxe-cell--required-icon'
      })]) : renderEmptyElement($table), (0, _utils.isEnableConf)(editRender) && editOpts.showIcon ? h('i', {
  ...
  runRenderer(h, params, _vm, isEdit) {
    ...
    if (isEdit) {
      ...
      if (rtEdit) {
        return (0, _vn.getSlotVNs)(rtEdit.call($table, h, editRender, cellParams));
      }
      return [];
    }
    if (slots && slots.default) {
