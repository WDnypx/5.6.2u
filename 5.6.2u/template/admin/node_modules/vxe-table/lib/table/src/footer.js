...
function renderRows(h, _vm, isOptimizeMode, tableColumn, footerTableData, row, $rowIndex, _rowIndex) {
  ...
  return tableColumn.map((column, $columnIndex) => {
    ...
    return h('td', {
      ...
      }, (0, _utils.getClass)(footerClassName, cellParams), (0, _utils.getClass)(footerCellClassName, cellParams)],
      attrs,
      style: footerCellStyle ? _xeUtils.default.isFunction(footerCellStyle) ? footerCellStyle(cellParams) : footerCellStyle : undefined,
      on: tfOns,
    ...
    if (!isColLoading && columnOpts.drag && columnDragOpts.animation) {
      return h('transition-group', {
        ...
        props: {
          ...
          style: footerRowStyle ? _xeUtils.default.isFunction(footerRowStyle) ? footerRowStyle(rowParams) : footerRowStyle : undefined
        }
